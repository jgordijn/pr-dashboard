...
Allow users with multiple GitHub accounts to switch between them from within the TUI dashboard, without restarting. The dashboard detects authenticated `gh` CLI accounts, provides a modal picker, and re-authenticates after switching.
